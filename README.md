...
- [`CREDITS.md`](CREDITS.md) — inspirations, third-party code, and asset
  attributions.
...
Inspirations and third-party attributions (including the app icon) are
collected in [`CREDITS.md`](CREDITS.md).
